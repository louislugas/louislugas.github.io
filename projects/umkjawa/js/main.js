...
var url = '../projects/umkjawa/geojson/UMKSBHJawa.geojson';
...
function populateKabkot() {
 ...
 $.ajax({
   url: "../projects/umkjawa/geojson/UMKSBHJawa.geojson",
   dataType:  "json",
   type: "get",
   cache: false,
...
//  //console.log(inputDewasa);
  ...
  if (inputDewasa == 1 && inputAnak == 0) {document.getElementById("family").src = "/img/Icon-08.svg";}
  else if (inputDewasa == 1 && inputAnak == 1) {document.getElementById("family").src = "/img/Icon-07.svg";}
  else if (inputDewasa == 1 && inputAnak == 2) {document.getElementById("family").src = "/img/Icon-06.svg";}
  else if (inputDewasa == 1 && inputAnak == 3) {document.getElementById("family").src = "/img/Icon-05.svg";}
  else if (inputDewasa == 2 && inputAnak == 0) {document.getElementById("family").src = "/img/Icon-01.svg";}
  else if (inputDewasa == 2 && inputAnak == 1) {document.getElementById("family").src = "/img/Icon-02.svg";}
  else if (inputDewasa == 2 && inputAnak == 2) {document.getElementById("family").src = "/img/Icon-03.svg";}
  else if (inputDewasa == 2 && inputAnak == 3) {document.getElementById("family").src = "/img/Icon-04.svg";}
  else if (inputDewasa == 3 && inputAnak == 0) {document.getElementById("family").src = "/img/Icon-01.svg";}
  else if (inputDewasa == 3 && inputAnak == 1) {document.getElementById("family").src = "/img/Icon-02.svg";}
  else if (inputDewasa == 3 && inputAnak == 2) {document.getElementById("family").src = "/img/Icon-03.svg";}
  else if (inputDewasa == 3 && inputAnak == 3) {document.getElementById("family").src = "/img/Icon-04.svg";};
